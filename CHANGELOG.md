...
* Return model not found instead of the internal model index when getting a model before any model is trained [#PRNUM](https://github.com/opensearch-project/k-NN/pull/PRNUM)
