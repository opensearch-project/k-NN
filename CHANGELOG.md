...
### Features
* Add dynamic mapping for knn_vector fields via plugin inferencer and knn_vector dynamic templates [#2247](https://github.com/opensearch-project/k-NN/issues/2247)
