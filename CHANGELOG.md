...
### Bug Fixes
* Return all nested child documents when rescoring is enabled with expand_nested_docs on the Lucene engine [#3125](https://github.com/opensearch-project/k-NN/issues/3125)
