...
public class Lucene102BinaryQuantizedVectorsReader extends FlatVectorsReader {
        ...
        try (ChecksumIndexInput meta = state.directory.openChecksumInput(metaFileName)) {
            ...
            try {
                versionMeta = CodecUtil.checkIndexHeader(
                    ...
                    Lucene102BinaryQuantizedVectorsFormatConstants.VERSION_START,
    ...
    public Map<String, Long> getOffHeapByteSize(FieldInfo fieldInfo) {
        ...
        var quant = Map.of(Lucene102BinaryQuantizedVectorsFormatConstants.VECTOR_DATA_EXTENSION, fieldEntry.vectorDataLength());
