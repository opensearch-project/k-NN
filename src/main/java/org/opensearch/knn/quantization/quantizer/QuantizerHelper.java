...
class QuantizerHelper {
    ...
    public class QuantizerHelperResult {
        ...
        public QuantizerHelperResult(float[][] thresholds) {
    ...
    private static QuantizerHelperResult calculateQuantizationStateHelper(
        ...
        if (bitsPerCoordinate == 1) {
            ...
            Pair<float[], float[]> belowAbove = calculateBelowAboveThresholdMeans(trainingRequest, thresholds[0], sampledIndices);
            return new QuantizerHelperResult(thresholds, belowAbove.getA(), belowAbove.getB());
        } else {
            return new QuantizerHelperResult(thresholds);
        }
    }
