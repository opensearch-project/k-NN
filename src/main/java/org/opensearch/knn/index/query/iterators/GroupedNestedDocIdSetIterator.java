 ...
 *
 * The order of document IDs in {@link #docIds} does not need to be sorted. Since {@link #docIds} is accessed by index,
 * it should be a list that supports efficient `get(index)` operations. Here, we use an `ArrayList`.
 *
 */
public class GroupedNestedDocIdSetIterator extends DocIdSetIterator {
    ...
    public GroupedNestedDocIdSetIterator(final BitSet parentBitSet, final ArrayList<Integer> docIds, final Bits filterBits) {
