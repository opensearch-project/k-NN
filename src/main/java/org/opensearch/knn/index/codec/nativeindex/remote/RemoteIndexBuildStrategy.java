...
public class RemoteIndexBuildStrategy implements NativeIndexBuildStrategy {
    ...
    /**
        ...
        private final VectorRepositoryAccessor vectorRepositoryAccessor;
        private final String blobName;

        /**
         *
         */
        private RepositoryContext(BlobStoreRepository blobStoreRepository, BlobPath blobPath,
                                  VectorRepositoryAccessor vectorRepositoryAccessor, String blobName) {
            this.blobStoreRepository = blobStoreRepository;
            this.blobPath = blobPath;
            this.vectorRepositoryAccessor = vectorRepositoryAccessor;
            this.blobName = blobName;
        }

        public BlobStoreRepository blobStoreRepository() {
            return blobStoreRepository;
        }

        public BlobPath blobPath() {
            return blobPath;
        }

        public VectorRepositoryAccessor vectorRepositoryAccessor() {
            return vectorRepositoryAccessor;
        }
        ...
        public boolean equals(Object obj) {
            ...
            var that = (RepositoryContext) obj;
            return Objects.equals(this.blobStoreRepository, that.blobStoreRepository) &&
                    Objects.equals(this.blobPath, that.blobPath) &&
                    Objects.equals(this.vectorRepositoryAccessor, that.vectorRepositoryAccessor) &&
                    Objects.equals(this.blobName, that.blobName);
        }

        @Override
        public int hashCode() {
            return Objects.hash(blobStoreRepository, blobPath, vectorRepositoryAccessor, blobName);
        }
        ...
        public String toString() {
            return "RepositoryContext[" +
                    ...
                    "blobPath=" + blobPath + ", " +
                    "vectorRepositoryAccessor=" + vectorRepositoryAccessor + ", " +
                    "blobName=" + blobName + ']';
        }
    ...
    static RemoteBuildRequest buildRemoteBuildRequest(
        ...
        switch (repositoryType) {
            case S3:
                containerName = repositoryMetadata.settings().get(BUCKET);
                break;
            default:
