...
public class FlatVectorFieldMapper extends KNNVectorFieldMapper {
    ...
    public static FlatVectorFieldMapper createFieldMapper(
        ...
        final KNNVectorFieldType mappedFieldType = new KNNVectorFieldType(
            fullname,
            metaValue,
            () -> KNNVectorFieldType.KNNVectorFieldTypeConfig.builder().dimension(dimension).vectorDataType(vectorDataType).build(),
            null
        );
    ...
    private FlatVectorFieldMapper(
        ...
        this.perDimensionValidator = selectPerDimensionValidator(mappedFieldType.getVectorDataType());
