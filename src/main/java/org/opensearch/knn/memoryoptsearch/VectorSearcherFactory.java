...
public interface VectorSearcherFactory {
     ...
     * @throws IOException
     */
    VectorSearcher createVectorSearcher(Directory directory, String fileName, FieldInfo fieldInfo ,FlatVectorsReaderWithFieldName flatVectorsReaderWithFieldName)
        throws IOException;
}
