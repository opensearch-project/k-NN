...
public class QuantizationStateTests extends KNNTestCase {
    ...
    public void testMultiBitScalarQuantizationState_getBytesPerVector() {
        ...
        ScalarQuantizationParams params2bit = new ScalarQuantizationParams(ScalarQuantizationType.TWO_BIT);
        float[][] thresholds2D = { { 0.5f, 1.5f }, { 1.0f, 2.0f } };
        MultiBitScalarQuantizationState state2D = new MultiBitScalarQuantizationState(params2bit, thresholds2D);
        ...
        MultiBitScalarQuantizationState state12D = new MultiBitScalarQuantizationState(params2bit, thresholds12D);
        assertEquals(3, state12D.getBytesPerVector()); // 24 bits = 3 bytes

        // Test 2D with 4 bits (8x compression)
        ScalarQuantizationParams params4bit = new ScalarQuantizationParams(ScalarQuantizationType.FOUR_BIT);
        float[][] thresholds2D_4bit = new float[4][2];
        MultiBitScalarQuantizationState state2D_4bit = new MultiBitScalarQuantizationState(params4bit, thresholds2D_4bit);
        ...
        MultiBitScalarQuantizationState state12D_4bit = new MultiBitScalarQuantizationState(params4bit, thresholds12D_4bit);
    ...
    public void testOneBitScalarQuantizationState_getBytesPerVector() {
        ...
        OneBitScalarQuantizationState state2D = new OneBitScalarQuantizationState(params, thresholds2D);
        ...
        OneBitScalarQuantizationState state12D = new OneBitScalarQuantizationState(params, thresholds12D);
    ...
    public void testMultiBitScalarQuantizationState_getDimensions_fixedLogic() {
        ...
        MultiBitScalarQuantizationState state5D_4bit = new MultiBitScalarQuantizationState(params4bit, thresholds5D_4bit);
