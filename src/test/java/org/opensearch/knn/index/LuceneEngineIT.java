...
public class LuceneEngineIT extends KNNRestTestCase {
    ...
    public void testAddSearchDeleteWithCompressionLevelImpliedBBQ() {
        createKnnIndexMappingWithLuceneEngineWithModeAndCompression(
            CompressionLevel.x32, DIMENSION, Mode.NOT_CONFIGURED
        );
    ...
    public void testAddSearchDeleteWithModeImpliedBBQ() {
        createKnnIndexMappingWithLuceneEngineWithModeAndCompression(
            CompressionLevel.NOT_CONFIGURED, DIMENSION, Mode.ON_DISK
        );
        addSearchDeleteToCurrentKNNIndex();
    }
    ...
    private void createKnnIndexMappingWithLuceneEngineWithModeAndCompression(
        CompressionLevel compressionLevel, int dimension, Mode mode) throws Exception {
        XContentBuilder builder = XContentFactory.jsonBuilder()
            .startObject()
            .startObject(PROPERTIES_FIELD_NAME)
            .startObject(FIELD_NAME)
        ...
        if (mode != Mode.NOT_CONFIGURED) {
            builder.field(MODE_FIELD_NAME, mode.fromName())
        }
        builder.endObject()
            .endObject()
            .endObject();
