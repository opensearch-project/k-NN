...
public class KNNWeightTests extends KNNTestCase {
    ...
    public void testQueryScoreForFaissWithModel() {
        ...
        final String indexUUID = null;
        final int shardId = -1;
        final KNNWeight knnWeight = new KNNWeight(query, boost, indexUUID, shardId);
    ...
    public void testQueryScoreForFaissWithNonExistingModel() throws IOException {
        ...
        final String indexUUID = null;
        final int shardId = -1;
        final KNNWeight knnWeight = new KNNWeight(query, 0.0f, indexUUID, shardId);
    ...
    public void validateANNWithFilterQuery_whenDoingANN_thenSuccess(final boolean isBinary) throws IOException {
        ...
        final String indexUUID = null;
        final int shardId = -1;
        final KNNWeight knnWeight = new KNNWeight(query, boost, filterQueryWeight, indexUUID, shardId);
    ...
    public void testANNWithFilterQuery_whenEmptyFilterIds_thenReturnEarly() {
        ...
        final String indexUUID = null;
        final int shardId = -1;
        final KNNWeight knnWeight = new KNNWeight(query, 0.0f, filterQueryWeight, indexUUID, shardId);
