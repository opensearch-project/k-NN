...
public class NativeEngineKnnVectorQueryRadialTests extends KNNTestCase {
    ...
    public void testConstructor_whenExactSearcherNotInitialized_thenThrows() {
        NativeEngineKnnVectorQuery.initialize(null);
        try {
            NullPointerException e = expectThrows(
                NullPointerException.class,
                () -> NativeEngineKnnVectorQuery.createRadialRescoreQuery(
    ...
    public void testScorerSupplier_whenLeafHasNoCandidates_thenReturnsNull() {
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader reader = DirectoryReader.open(directory)) {
                ...
                final NativeEngineKnnVectorQuery query = newRescoreQuery(new MatchNoDocsQuery(), MAX_RESULTS_RADIAL_RESCORING, false);
    ...
    public void testEqualsAndHashCode() {
        ...
        NativeEngineKnnVectorQuery q1 = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
            innerQuery,
            FIELD_NAME,
            QUERY_VECTOR,
            RADIUS,
        ...
        NativeEngineKnnVectorQuery q2 = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
            innerQuery,
            FIELD_NAME,
            QUERY_VECTOR,
            RADIUS,
        ...
        // Different radius
        NativeEngineKnnVectorQuery q3 = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
            innerQuery,
            FIELD_NAME,
            QUERY_VECTOR,
            0.9f,
        ...
        // Different field
        NativeEngineKnnVectorQuery q4 = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
            innerQuery,
            "other-field",
            QUERY_VECTOR,
            RADIUS,
        ...
        // Different vector
        NativeEngineKnnVectorQuery q5 = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
            innerQuery,
            FIELD_NAME,
            new float[] { 9.0f },
            RADIUS,
        ...
        NativeEngineKnnVectorQuery topKQuery = new NativeEngineKnnVectorQuery(mock(KNNQuery.class), QueryUtils.getInstance(), false);
        assertNotEquals(q1, topKQuery);
    }

    public void testToString() {
        Query innerQuery = new MatchAllDocsQuery();
        NativeEngineKnnVectorQuery query = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
            innerQuery,
            FIELD_NAME,
            QUERY_VECTOR,
            RADIUS,
        ...
        assertTrue(str.contains("NativeEngineKnnVectorQuery"));
    ...
    public void testRescore_withBoost_thenScoresAreScaled() {
        ...
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader reader = DirectoryReader.open(directory)) {
                final IndexSearcher searcher = new IndexSearcher(reader);
                final NativeEngineKnnVectorQuery rescoreQuery = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
                    new MatchAllDocsQuery(),
                    FIELD_NAME,
                    queryVector,
                    radiusThreshold,
    ...
    public void testGetters() {
        ...
        assertTrue(query.isRadialSearch());
        assertNull(query.getKnnQuery());
    ...
    public void testRewrite_converges() throws IOException {
        ...
        assertTrue(firstRewrite instanceof NativeEngineKnnVectorQuery);
        assertNotSame(query, firstRewrite);
        NativeEngineKnnVectorQuery rewrittenQuery = (NativeEngineKnnVectorQuery) firstRewrite;
    ...
    public void testRewrite_preservesFirstPassK() throws IOException {
        ...
        NativeEngineKnnVectorQuery rewrittenQuery = (NativeEngineKnnVectorQuery) query.rewrite(searcher);
    ...
    private NativeEngineKnnVectorQuery newRescoreQuery(
    ...
    // When: NativeEngineKnnVectorQuery rescores with full precision
            ...
            try (IndexReader reader = DirectoryReader.open(directory)) {
                {
                    ...
                    NativeEngineKnnVectorQuery rescoreQuery = NativeEngineKnnVectorQuery.createRadialRescoreQuery(
                        innerQuery,
                        FIELD_NAME,
                        queryVector,
                        radiusThreshold,
    ...
    // When: NativeEngineKnnVectorQuery rescores
