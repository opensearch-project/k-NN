...
public class KNNVectorFieldMapperUtilTests extends KNNTestCase {
    ...
    public void testUseLuceneKNNVectorsFormat_withDifferentInputs_thenSuccess() {
        ...
        Assert.assertFalse(KNNVectorFieldMapperUtil.useLuceneKNNVectorsFormat(Version.V_2_16_0, true));
        Assert.assertFalse(KNNVectorFieldMapperUtil.useLuceneKNNVectorsFormat(Version.V_3_0_0, true));

        mockedStatic.when(KNNSettings::getIsLuceneVectorFormatEnabled).thenReturn(true);
        Assert.assertTrue(KNNVectorFieldMapperUtil.useLuceneKNNVectorsFormat(Version.V_2_17_0, true));
        Assert.assertTrue(KNNVectorFieldMapperUtil.useLuceneKNNVectorsFormat(Version.V_3_0_0, true));

        Assert.assertFalse(KNNVectorFieldMapperUtil.useLuceneKNNVectorsFormat(Version.V_2_17_0, false));
        Assert.assertFalse(KNNVectorFieldMapperUtil.useLuceneKNNVectorsFormat(Version.V_3_0_0, false));
