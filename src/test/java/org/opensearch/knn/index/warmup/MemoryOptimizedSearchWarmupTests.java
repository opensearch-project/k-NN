...
public class MemoryOptimizedSearchWarmupTests extends KNNTestCase {
    ...
    public void setUp() throws Exception {
        ...
        org.opensearch.cluster.metadata.IndexMetadata indexMetadata = mock(org.opensearch.cluster.metadata.IndexMetadata.class);

        org.opensearch.common.settings.Settings indexSettings = org.opensearch.common.settings.Settings.builder()
            .put("index.knn.memory_optimized_search", true)
            .build();
