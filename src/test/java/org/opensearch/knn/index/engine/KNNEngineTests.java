...
public class KNNEngineTests extends KNNTestCase {
    ...
    public void testSupportsRemoteIndexBuild() {
        ...
        // BF16 remote build is blocked: the remote builder uses fp16 (half_float) as its build-time data type and
        // would silently truncate bf16 values outside the fp16 range. Keep bf16 on the local build path.
        assertFalse(Faiss.supportsRemoteIndexBuild(createMockKnnLibraryIndexingContextParamsBF16()));
