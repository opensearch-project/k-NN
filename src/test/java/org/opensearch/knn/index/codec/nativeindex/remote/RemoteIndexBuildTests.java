...
abstract class RemoteIndexBuildTests extends KNNTestCase {
    ...
    static class TestIndexBuildStrategy implements NativeIndexBuildStrategy {
        private final SetOnce<Boolean> fallback;

        TestIndexBuildStrategy(SetOnce<Boolean> fallback) {
        ...
        public SetOnce<Boolean> fallback() {
            return fallback;
        }
    }
