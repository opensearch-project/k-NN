...
public class KNN91DocValuesConsumerTests extends KNNTestCase {
    ...
    public void testAddBinaryField_withKNN() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(delegate, null) {
        ...
        knn91DocValuesConsumer.addBinaryField(fieldInfo, docValuesProducer);
    ...
    public void testAddBinaryField_withoutKNN() throws IOException {
        // Confirm that the KNN91DocValuesConsumer will just call delegate AddBinaryField when k-NN parameter is
        // not set
    ...
    public void testAddKNNBinaryField_noVectors() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(null, null);
        knn91DocValuesConsumer.addKNNBinaryField(null, randomVectorDocValuesProducer);
    ...
    public void testAddKNNBinaryField_fromScratch_nmslibCurrent() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(null, state);
        RandomVectorDocValuesProducer randomVectorDocValuesProducer = new RandomVectorDocValuesProducer(docsInSegment, dimension);
        knn91DocValuesConsumer.addKNNBinaryField(fieldInfoArray[0], randomVectorDocValuesProducer);
    ...
    public void testMerge_exception() throws IOException {
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(null, null);
        expectThrows(RuntimeException.class, () -> knn91DocValuesConsumer.merge(null));
    }
    ...
    public void testAddSortedSetField() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(delegate, null);
        knn91DocValuesConsumer.addSortedSetField(null, null);
    ...
    public void testAddSortedNumericField() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(delegate, null);
        knn91DocValuesConsumer.addSortedNumericField(null, null);
    ...
    public void testAddSortedField() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(delegate, null);
        knn91DocValuesConsumer.addSortedField(null, null);
    ...
    public void testAddNumericField() throws IOException {
        ...
        KNN91DocValuesConsumer knn91DocValuesConsumer = new KNN91DocValuesConsumer(delegate, null);
        knn91DocValuesConsumer.addNumericField(null, null);
