...
public class KNN80DocValuesConsumerTests extends KNNTestCase {
    ...
    public void testAddKNNBinaryField_noVectors() throws IOException {
        ...
        FieldInfo fieldInfo = KNNCodecTestUtil.FieldInfoBuilder.builder("test-field").build();
        knn80DocValuesConsumer.addKNNBinaryField(fieldInfo, randomVectorDocValuesProducer, true);
    ...
    public void testAddKNNBinaryField_fromScratch_faissCurrent() throws IOException {
        ...
        KNNVectorValues<?> osKNNVectorValues = knn80DocValuesConsumer.addKNNBinaryField(
            fieldInfoArray[0],
            randomVectorDocValuesProducer,
            false
        );
        KnnVectorValues knnVectorValues = new KnnFloatVectorValuesAdapter((KNNVectorValues<float[]>) osKNNVectorValues);
