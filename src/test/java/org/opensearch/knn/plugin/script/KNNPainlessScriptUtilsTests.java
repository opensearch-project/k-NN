...
public class KNNPainlessScriptUtilsTests extends OpenSearchTestCase {
    ...
    public void testLateInteractionScoreWithEmptyVectors() {
        ...
        assertEquals(0.0, KNNPainlessScriptUtils.lateInteractionScore(emptyQueryVectors, "my_vector", doc), 0.0);

        // Test with null query vectors
        assertEquals(0.0, KNNPainlessScriptUtils.lateInteractionScore(null, "my_vector", doc), 0.0);
    ...
    public void testLateInteractionScoreWithDimensionMismatch() {
        ...
        assertEquals(0.0, KNNPainlessScriptUtils.lateInteractionScore(queryVectors, "my_vector", doc), 0.0);
    }
