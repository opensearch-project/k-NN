...
public class FaissMemoryOptimizedSearcherTests extends KNNTestCase {
    ...
    private void doSearchTest(
        ...
        KNNVectorValues<?> knnVectorValues = testingSpec.dataType == VectorDataType.FLOAT
            ? createKNNFloatVectorValues(buildInfo.documentIds, buildInfo.vectors.floatVectors)
            : createKNNByteVectorValues(buildInfo.documentIds, buildInfo.vectors.byteVectors);
