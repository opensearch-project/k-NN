...
import static org.opensearch.knn.index.query.memoryoptsearch.optimistic.Optimistic2ndSearchUtils.findKthLargestScore;

public class Optimistic2ndSearchUtilsTests {
    /**
