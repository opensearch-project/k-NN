...
public class FaissFloatVectorValuesTests extends KNNTestCase {
    ...
    public void testSparseVectorsValues_whenNonHasIndexSlice_constructorSucceedsAndGetSliceThrows() {
        ...
        // getSlice() throws only if a caller actually asks for the raw slice.
        expectThrows(IllegalArgumentException.class, sparse::getSlice);
    }
