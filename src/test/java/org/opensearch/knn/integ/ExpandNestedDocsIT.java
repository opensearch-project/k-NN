...
public class ExpandNestedDocsIT extends KNNRestTestCase {
    ...
    public void testExpandNestedDocs_whenFilteredOnParentDoc_thenReturnAllNestedDoc() {
        ...
        addVectorWithTopLevelField(1, numberOfNestedFields, FIELD_NAME_PARKING, FIELD_VALUE_TRUE);
        addVectorWithTopLevelField(2, numberOfNestedFields, FIELD_NAME_PARKING, FIELD_VALUE_TRUE);
        addVectorWithTopLevelField(3, numberOfNestedFields, FIELD_NAME_PARKING, FIELD_VALUE_TRUE);
        addVectorWithTopLevelField(4, numberOfNestedFields, FIELD_NAME_PARKING, FIELD_VALUE_TRUE);
        addVectorWithTopLevelField(5, numberOfNestedFields, FIELD_NAME_PARKING, FIELD_VALUE_TRUE);
    ...
    public void testExpandNestedDocs_whenFilteredOnNestedFieldDoc_thenReturnFilteredNestedDoc() {
        int numberOfNestedFields = 2;
        createKnnIndex(engine, mode, dimension, dataType);
        addVectorWithNestedLevelField(1, numberOfNestedFields, FIELD_NAME_STORAGE, Arrays.asList(FIELD_VALUE_FALSE, FIELD_VALUE_FALSE));
        addVectorWithNestedLevelField(2, numberOfNestedFields, FIELD_NAME_STORAGE, Arrays.asList(FIELD_VALUE_TRUE, FIELD_VALUE_TRUE));
        addVectorWithNestedLevelField(3, numberOfNestedFields, FIELD_NAME_STORAGE, Arrays.asList(FIELD_VALUE_TRUE, FIELD_VALUE_TRUE));
        addVectorWithNestedLevelField(4, numberOfNestedFields, FIELD_NAME_STORAGE, Arrays.asList(FIELD_VALUE_FALSE, FIELD_VALUE_TRUE));
        addVectorWithNestedLevelField(5, numberOfNestedFields, FIELD_NAME_STORAGE, Arrays.asList(FIELD_VALUE_TRUE, FIELD_VALUE_FALSE));
        deleteKnnDoc(INDEX_NAME, String.valueOf(1));
        addVectorWithNestedLevelField(2, numberOfNestedFields, FIELD_NAME_STORAGE, Arrays.asList(FIELD_VALUE_FALSE, FIELD_VALUE_FALSE));
    ...
    private void updateVectorWithTopLevelField(
        ...
        addVectorWithTopLevelField(docId, numOfNestedFields, fieldName, fieldValue);
    }

    private void addVectorWithTopLevelField(final int docId, final int numOfNestedFields, final String fieldName, final String fieldValue)
        throws IOException {
    ...
    private void addVectorWithNestedLevelField(
        final int docId,
        final int numOfNestedFields,
