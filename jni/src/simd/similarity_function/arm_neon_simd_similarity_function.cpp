...
struct ArmNeonBBQSimilarityFunction final : SimilarityFunction {
...
//
// 1. Max IP
ArmNeonBBQSimilarityFunction<true> BBQ_IP_SIMIL_FUNC;
// 2. L2
ArmNeonBBQSimilarityFunction<false> BBQ_L2_SIMIL_FUNC;
