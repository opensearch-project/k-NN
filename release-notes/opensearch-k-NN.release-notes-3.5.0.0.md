...
* Include AdditionalCodecs and EnginePlugin::getAdditionalCodecs hook to allow additional Codec registration ([#3088](https://github.com/opensearch-project/k-NN/pull/3088))